...
function cCppProperties.includeDirs(prj, cfg)
    ...
    local hasIncludeDirs = #externalincludedirs > 0 or #includedirs > 0
    ...
    if hasIncludeDirs then
        ...
        for _, includedir in ipairs(externalincludedirs) do
...
function cCppProperties.forceIncludes(prj, cfg)
    ...
    table.foreachi(forceincludes, function(file)
