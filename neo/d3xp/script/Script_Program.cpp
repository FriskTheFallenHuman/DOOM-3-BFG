...
void idProgram::CompileStats() {
	...
	gameLocal.Printf( S_COLOR_WHITE "  Statements: " S_COLOR_GREEN "%d, %zd bytes\n", statements.Num(), statements.MemoryUsed() );
	...
	gameLocal.Printf( S_COLOR_WHITE " Static data: " S_COLOR_GREEN "%zd bytes\n", sizeof( idProgram ) );
	gameLocal.Printf( S_COLOR_WHITE "   Allocated: " S_COLOR_GREEN "%d bytes\n", memallocated );
	gameLocal.Printf( S_COLOR_WHITE " Thread size: " S_COLOR_GREEN "%zd bytes\n", sizeof( idThread ) );
}
